...
function HTTPClient(e,t){if(!e.url)throw new SMSGHError("Provide a url for the request");return this instanceof HTTPClient?(this.url=e.url,this.method="delete"===e.method?"del":e.method,this.data=e.data||null,this.headers=e.headers||{},this.request=request[this.method](this.url),this.cb=t&&"function"==typeof t?t:function(){},this.prepareForReq(),void this.makeRequest()):new HTTPClient(e,t)}function httpClient(e,t){return new HTTPClient(e,t)}var request=require("superagent"),SMSGHError=require("./error");HTTPClient.prototype.setHeader=function(e,t){if("string"==typeof e&&t){var r=e;e={},e[r]=t}for(var i in e)e.hasOwnProperty(i)&&(this.headers[i]=e[i])},HTTPClient.prototype.prepareForReq=function(){this.request.set(this.headers),this.data&&this.request.send(this.data)},HTTPClient.prototype.makeRequest=function(){var e=this;this.request.end(function(t,r){return t?e.cb(t,r):void e.cb(null,r)})},["get","post","put","delete","head"].forEach(function(e){httpClient["delete"===e?"del":e]=function(t,r){return t.method=e,new HTTPClient(t,r)}}),httpClient.HTTPClient=HTTPClient,module.exports=httpClient;

},{"./error":1,"superagent":15}],3:[function(require,module,exports){
function isAnImportantParamMissing(e){for(var t=0,s=Message._importantParams.length;s>t;t++){var r=e[Message._importantParams[t]];if(null===r||void 0===r)return!0}}function Message(e){if(!(this instanceof Message))return new Message(e);if(this.type=e.type||0,this.clientReference=e.clientReference||null,this.direction=e.direction||null,this.flashMessage=e.flash||null,this.messageId=e.messageId||null,this.networkId=e.networkId||null,this.rate=e.rate||null,this.registeredDelivery=e.registeredDelivery||null,this.status=e.status||null,this.time=e.time||null,this.udh=e.udh||null,this.units=e.units||null,this.updateTime=e.updateTime||null,isAnImportantParamMissing(e))throw new SMSGHError("An important parameter is missing from the object provided. Important params are from, to and content");var t=0,s=Message._importantParams.length;for(t=0;s>t;t++)this[Message._importantParams[t]]=e[Message._importantParams[t]]}var SMSGHError=require("./error");Message.prototype.toJSON=function(){var e={},t=this;for(var s in t)if(t.hasOwnProperty(s)){var r=t[s];r&&("to"===s&&(r=/^\+/.test(r)?encodeURIComponent(r):"+"+r),e[s.charAt(0).toUpperCase()+s.substr(1)]=r)}return JSON.stringify(e)},Message.castToMessageObj=function(e){return new Message(e)},Message._importantParams=["content","from","to"],module.exports=Message;

},{"./error":1}],4:[function(require,module,exports){
function SendMessage(e,t,s){return this instanceof SendMessage?(this.clientId=e,this.clientSecret=t,this._auth=utils.encode(this.clientId+":"+this.clientSecret),this._noopCallback=function(){},this._headers={Accept:"application/json",Authorization:"Basic "+this._auth},this.versionNumber=s,this.lastQueryTime,void this.setContextPath()):new SendMessage(e,t,s)}var util=require("util"),httpClient=require("./httpclient"),Message=require("./message"),utils=require("./utils"),SMSGHError=require("./error");SendMessage.prototype._callbackProvider=function(e){return e&&"function"==typeof e?e:this._noopCallback},SendMessage.prototype.setContextPath=function(e){SendMessage.BASE_URL=util.format(SendMessage.BASE_URL,e)},SendMessage.prototype.send=function(e,t){e instanceof Message||(e=Message.castToMessageObj(e)),t=this._callbackProvider(t),httpClient.post({url:SendMessage.BASE_URL,headers:utils.merge(this._headers,{"Content-Type":"application/json"}),data:e.toJSON()},function(e,s){return e?t(e,s):void((201===s.status||2===(s.status/100|0))&&t(null,s.body))})},SendMessage.prototype.sendQuickMessage=function(e,t,s,n){var i=new Message({from:e,to:t,content:s});this.send(i,n)},SendMessage.prototype.sendScheduledMessage=function(e,t){if(e instanceof Message||(e=Message.castToMessageObj(e)),!e.time)throw new SMSGHError("A scheduled message object must have a time value");this.send(e,t)},SendMessage.prototype.getMessage=function(e,t){t=this._callbackProvider(t),httpClient.get({headers:this._headers,url:SendMessage.BASE_URL+"/"+e},function(e,s){return e?t(e,s):void t(null,s.body)})},SendMessage.prototype.queryMessage=function(e,t){if(this.lastQueryTime&&~~((Date.now()-this.lastQueryTime)/1e3)<5)throw new SMSGHError("You must query within 5 second intervals.");this.lastQueryTime=Date.now(),t=this._callbackProvider(t),httpClient.get({url:SendMessage.BASE_URL+"?"+utils.serialize(e),headers:this._headers},function(e,s){return e?t(e,s):void t(null,s)})},SendMessage.prototype.rescheduleMessage=function(e,t,s){if(!e)throw new SMSGHError("Provide the message id of the message to be rescheduled");s=this._callbackProvider(s),httpClient.put({url:SendMessage.BASE_URL+"/"+e,headers:utils.merge(this._headers,{"Content-Type":"application/json"}),data:{Time:t}},function(e,t){return e?s(e,t):void s(null,t)})},SendMessage.prototype.cancel=function(e,t){t=this._callbackProvider(t),httpClient.del({url:SendMessage.BASE_URL+"/"+e,headers:this._headers},function(e,s){return e?t(e,s):void t(null,s)})},SendMessage.BASE_URL="https://api.smsgh.com/%s/messages",module.exports=SendMessage;

},{"./error":1,"./httpclient":2,"./message":3,"./utils":6,"util":14}],5:[function(require,module,exports){
function TopUp(e){if(!e)throw new SMSGHError("Provie an api key");if("string"!=typeof e)throw new SMSGHError("Make sure the provided "+e+" is a string");this.apiKey=e}var httpClient=require("./httpclient"),utils=require("./utils"),SMSGHError=require("./error");TopUp.prototype.topItUp=function(e,o){e&&"object"==typeof e||o(new SMSGHError("Make sure the provied options is an object"),null),e.network=e.network.toLowerCase(),e.method=(void 0!==e.method?e.method:"GET").toLowerCase(),o=o||function(){};for(var t=!1,r=0,p=TopUp.NETWORKS.length;p>r;r++)if(TopUp.NETWORKS[r]===e.network){t=!0;break}t||o(new SMSGHError("Please make sure the network type is either mtn, vodafone, expresso, airtel, tigo or glo"),null);var i=utils.serialize({phone:e.phone,"line-type":e.lineType,network:e.network,amount:e.amount,"api-key":this.apiKey},!1,!0);"get"===e.method?httpClient.get({url:TopUp.BASE_URL+"?"+i},o):httpClient.post({url:TopUp.BASE_URL,headers:{"Content-Type":"application/x-www-form-urlencoded"},data:i},o)},TopUp.BASE_URL="https://api.smsgh.com/credit/topup",TopUp.NETWORKS=["mtn","vodafone","expresso","airtel","tigo","glo"],module.exports=TopUp;

},{"./error":1,"./httpclient":2,"./utils":6}],6:[function(require,module,exports){
(function (Buffer){
var has={}.hasOwnProperty,utils={};utils.encode=function(e){return new Buffer(e).toString("base64")},utils.serialize=function(e,n,r){var t=[];for(var o in e)has.call(e,o)&&t.push((n?encodeURIComponent(o):o)+"="+(r?encodeURIComponent(e[o]):e[o]));return t.join("&")},utils.merge=function(){for(var e={},n=[].slice.call(arguments,0),r=0,t=n.length;t>r;r++)for(var o in n[r])has.call(n[r],o)&&n[r][o]&&(e[o]=n[r][o]);return e},module.exports=utils;
...
function SMSGH(e,i,s){if(!(this instanceof SMSGH))return new SMSGH(e,i,s);if(void 0===e||void 0===i)throw new SMSGHError("Make sure clientid and clientSecret are both defined");this.clientId=e,this.clientSecret=i,this.apiKey=s,this.versionNumber="v3",this.messageApi=new SendMessage(e,i),this.apiKey&&(this.topUpApi=new TopUp(s))}var SMSGHError=require("./lib/error"),TopUp=require("./lib/topup"),SendMessage=require("./lib/sendmsg"),Message=require("./lib/message");SMSGH.prototype.setContextPath=function(e){"number"==typeof e&&(e="v"+e),this.versionNumber=e},SMSGH.TopUp=TopUp,SMSGH.SendMessage=SendMessage,SMSGH.Message=Message,module.exports=SMSGH;
},{"./lib/error":1,"./lib/message":3,"./lib/sendmsg":4,"./lib/topup":5}]},{},[18]);
