...
function Auth(t,e){if(!arguments.length||arguments.length<2)throw new SMSGHError("Provide authentication parameters");return this instanceof Auth?(this.clientId=t,this.clientSecret=e,void(this.basicAuth=utils.encode(this.clientId+":"+this.clientSecret))):new Auth(t,e)}var utils=require("./utils"),SMSGHError=require("./error");module.exports=Auth;

},{"./error":2,"./utils":9}],2:[function(require,module,exports){
...
var request=require("superagent"),SMSGHError=require("./error"),httpClient={},reqArr=["get","post","put","del","head"];reqArr.forEach(function(r){httpClient[r]=function(e,t){if(!e.url)throw new SMSGHError("Provide a url for the request");e.headers||(e.headers={});var n=request[r](e.url),u=t&&"function"==typeof t?t:function(){};n.set(e.headers),e.data&&n.send(this.data),n.end(function(r,e){return r?u(r,e):void u(null,e)})}}),module.exports=httpClient;

},{"./error":2,"superagent":18}],4:[function(require,module,exports){
var request=require("superagent"),SMSGHError=require("./error"),httpClient={},reqArr=["get","post","put","del","head"];reqArr.forEach(function(r){httpClient[r]=function(e,t){if(!e.url)throw new SMSGHError("Provide a url for the request");e.headers||(e.headers={});var n=request[r](e.url),u=t&&"function"==typeof t?t:function(){};n.set(e.headers),e.data&&n.send(this.data),n.end(function(r,e){return r?u(r,e):void u(null,e)})}}),module.exports=httpClient;

},{"./error":2,"superagent":18}],5:[function(require,module,exports){
function isAnImportantParamMissing(e){for(var t=0,s=Message._importantParams.length;s>t;t++){var r=e[Message._importantParams[t]];if(null===r||void 0===r)return!0}}function Message(e){if(!(this instanceof Message))return new Message(e);if(this.type=e.type||0,this.clientReference=e.clientReference||null,this.direction=e.direction||null,this.flashMessage=e.flash||null,this.messageId=e.messageId||null,this.networkId=e.networkId||null,this.rate=e.rate||null,this.registeredDelivery=e.registeredDelivery||null,this.status=e.status||null,this.time=e.time||null,this.udh=e.udh||null,this.units=e.units||null,this.updateTime=e.updateTime||null,isAnImportantParamMissing(e))throw new SMSGHError("An important parameter is missing from the object provided. Important params are from, to and content");var t=0,s=Message._importantParams.length;for(t=0;s>t;t++)this[Message._importantParams[t]]=e[Message._importantParams[t]]}var SMSGHError=require("./error");Message.prototype.toJSON=function(){var e={},t=this;for(var s in t)if(t.hasOwnProperty(s)&&t[s]&&"function"!=typeof t[s]){var r=t[s];"to"===s&&(r=~r.indexOf("+")?r:"+"+r),e[s.charAt(0).toUpperCase()+s.substr(1)]=r}return e},Message.castToMessageObj=function(e){return new Message(e)},Message._importantParams=["content","from","to"],module.exports=Message;

},{"./error":2}],6:[function(require,module,exports){
function SendMessage(e,s){return this instanceof SendMessage?(this._noopCallback=function(){},this._headers={Accept:"application/json",Authorization:"Basic "+e.basicAuth},this.versionNumber=s||"v3",this.lastQueryTime=0,void this.setContextPath()):new SendMessage(e,s)}var util=require("util"),httpClient=require("./httpclient"),Message=require("./message"),utils=require("./utils"),SMSGHError=require("./error");SendMessage.prototype._callbackProvider=function(e){return e&&"function"==typeof e?e:this._noopCallback},SendMessage.prototype.setContextPath=function(e){e=e||this.versionNumber,SendMessage.BASE_URL=util.format(SendMessage.BASE_URL_PLC,e)},SendMessage.prototype.send=function(e,s){e instanceof Message||(e=Message.castToMessageObj(e)),s=this._callbackProvider(s),httpClient.post({url:SendMessage.BASE_URL,headers:utils.merge(this._headers,{"Content-Type":"application/json"}),data:e.toJSON()},function(e,t){return e?s(e,t):void((201===t.status||2===(t.status/100|0))&&s(null,t.body))})},SendMessage.prototype.sendQuickMessage=function(e,s,t,n){var i=new Message({from:e,to:s,content:t});this.send(i,n)},SendMessage.prototype.sendScheduledMessage=function(e,s){if(e instanceof Message||(e=Message.castToMessageObj(e)),!e.time)throw new SMSGHError("A scheduled message object must have a time value");this.send(e,s)},SendMessage.prototype.getMessage=function(e,s){s=this._callbackProvider(s),httpClient.get({headers:this._headers,url:SendMessage.BASE_URL+"/"+e},function(e,t){return e?s(e,t):void s(null,t.body)})},SendMessage.prototype.queryMessage=function(e,s){if(this.lastQueryTime&&~~((Date.now()-this.lastQueryTime)/1e3)<5)throw new SMSGHError("You must query within 5 second intervals.");this.lastQueryTime=Date.now(),s=this._callbackProvider(s),httpClient.get({url:SendMessage.BASE_URL+"?"+utils.serialize(e),headers:this._headers},function(e,t){return e?s(e,t):void s(null,t)})},SendMessage.prototype.rescheduleMessage=function(e,s,t){if(!e)throw new SMSGHError("Provide the message id of the message to be rescheduled");t=this._callbackProvider(t),httpClient.put({url:SendMessage.BASE_URL+"/"+e,headers:utils.merge(this._headers,{"Content-Type":"application/json"}),data:{Time:s}},function(e,s){return e?t(e,s):void t(null,s)})},SendMessage.prototype.cancel=function(e,s){s=this._callbackProvider(s),httpClient.del({url:SendMessage.BASE_URL+"/"+e,headers:this._headers},function(e,t){return e?s(e,t):void s(null,t)})},SendMessage.BASE_URL_PLC="https://api.smsgh.com/%s/messages",SendMessage.BASE_URL="",module.exports=SendMessage;

},{"./error":2,"./httpclient":4,"./message":5,"./utils":9,"util":17}],7:[function(require,module,exports){
function TopUp(e){if(!(this instanceof TopUp))return new TopUp(e);if(!e||"string"!=typeof e)throw new SMSGHError("Provie an api key and make sure it is a string");this.apiKey=e}var httpClient=require("./httpclient"),utils=require("./utils"),SMSGHError=require("./error");TopUp.prototype.topItUp=function(e,t){e&&"object"==typeof e||t(new SMSGHError("Make sure the provied options is an object"),null),e.network=e.network.toLowerCase(),e.method=(void 0!==e.method?e.method:"GET").toLowerCase(),t=t||function(){};for(var o=!1,r=0,p=TopUp.NETWORKS.length;p>r;r++)if(TopUp.NETWORKS[r]===e.network){o=!0;break}o||t(new SMSGHError("Please make sure the network type is either mtn, vodafone, expresso, airtel, tigo or glo"),null);var i=utils.serialize({phone:e.phone,"line-type":e.lineType,network:e.network,amount:e.amount,"api-key":this.apiKey},!1,!0);"get"===e.method?httpClient.get({url:TopUp.BASE_URL+"?"+i},t):httpClient.post({url:TopUp.BASE_URL,headers:{"Content-Type":"application/x-www-form-urlencoded"},data:i},t)},TopUp.BASE_URL="https://api.smsgh.com/credit/topup",TopUp.NETWORKS=["mtn","vodafone","expresso","airtel","tigo","glo"],module.exports=TopUp;

},{"./error":2,"./httpclient":4,"./utils":9}],8:[function(require,module,exports){
function callbackWrapper(e){if(!e||"function"!=typeof e)throw new SMSGHError("Provide callback for api request");return function(t,r){return t?e(t,null):e(null,r.body)}}function USP(e,t){if(!e)throw new SMSGHError("Provide the auth object for authentication");return this instanceof USP?void(this.defaultHeaders={Authorization:"Basic "+e.basicAuth,"Cotent-Type":"application/json",Accept:"application/json"}):new USP(e)}var SMSGHError=require("./error"),utils=require("./utils"),httpClient=require("./httpClient");USP.prototype.topupAirtime=function(e,t,r,a){e=USP.NETWORK_IDS[e.toLowerCase()];var o=this;if(!utils.isValidTelephoneNumber(r))throw new SMSGHError("Number `"+r+" is invalid ");a=callbackWrapper(a),httpClient.post({url:USP.BASE_URL+"usp/airtime",headers:o.defaultHeaders,data:{network:e.toString(),amount:t,phone:r,token:o.token}},a)},USP.prototype.payDSTV=function(e,t,r){if(arguments.length<2)throw new SMSGHError("Provide a an account and amount");var a=this;r=callbackWrapper(r),httpClient.post({url:USP.BASE_URL+"usp/dstv",headers:a.defaultHeaders,data:{account:e,amount:t,token:a.token}},r)},USP.prototype.querySurflineDevice=function(e,t){if(!utils.isValidTelephoneNumber(e))throw new SMSGHError("Number `"+e+"` is invalid ");var r=this;t=callbackWrapper(t),httpClient.post({url:USP.BASE_URL+"usp/surfline?"+e,headers:r.defaultHeaders,data:{}},t)},USP.prototype.bundleSurflinePlus=function(e,t,r){if(t>50||!~[1,5,10,20,50].indexOf(t))throw new SMSGHError("Make sure the specified amount is in the range of 1,5,10,20,50");var a=this;r=callbackWrapper(r),httpClient.post({url:USP.BASE_URL+"usp/surflineplus",header:a.defaultHeaders,data:{device:e.toString(),amount:t,token:a.token}},r)},USP.prototype.bundleSurfline=function(e,t,r,a){if(t>50||!~[1,5,10,20,50].indexOf(t))throw new SMSGHError("Make sure the specified amount is in the range of 1,5,10,20,50");a=callbackWrapper(a);var o=this;httpClient.post({url:USP.BASE_URL+"usp/surflineplus",header:o.defaultHeaders,data:{device:e.toString(),amount:t,bundle:r,token:o.token}},a)},USP.prototype.vodafoneInternet=function(e,t,r){r=callbackWrapper(r);var a=this;httpClient.post({url:USP.BASE_URL+"usp/vodafone-internet",header:a.defaultHeaders,data:{account:e,amount:t,token:a.token}},r)},USP.prototype.payVodafoneBills=function(e,t,r,a){if("postpaid"!==r||"broadband"!==r)throw new SMSGHError("The service should be either postpaid or broadband");a=callbackWrapper(a);var o=this;httpClient.post({url:USP.BASE_URL+"usp/vodafone",header:o.defaultHeaders,data:{account:e,amount:t,service:r}},a)},USP.prototype.getAccountBalance=function(e){e=callbackWrapper(e);var t=this;httpClient.get({url:USP+"usp/account/"+t.token,header:t.defaultHeaders},e)},USP.NETWORK_IDS={airtel:62006,vodafone:62002,expresso:62004,mtn:62001,globacom:62007,tigo:62003},USP.BASE_URL="https://api.smsgh.com/",module.exports=USP;

},{"./error":2,"./httpClient":3,"./utils":9}],9:[function(require,module,exports){
(function (Buffer){
...
},{"./error":2,"buffer":10}],10:[function(require,module,exports){
...
function SMSGH(e){if(!(this instanceof SMSGH))return new SMSGH(e);if(!e.clientId||!e.clientSecret)throw new SMSGHError("Make sure clientid and clientSecret are both defined");this.auth=new Auth(e.clientId,e.clientSecret),this.versionNumber="v3",this.messageApi=new SendMessage(this.auth,this.versionNumber),e.topupApiKey&&(this.topUpApi=new TopUp(e.topupApiKey)),e.uspToken&&(this.uspApi=new USP(this.auth,e.uspToken))}var SMSGHError=require("./lib/error"),TopUp=require("./lib/topup"),SendMessage=require("./lib/sendmsg"),USP=require("./lib/usp"),Message=require("./lib/message"),Auth=require("./lib/auth");SMSGH.prototype.setContextPath=function(e){"number"==typeof e&&(e="v"+e),this.versionNumber=e,this.messageApi.setContextPath(this.versionNumber)},SMSGH.TopUp=TopUp,SMSGH.SendMessage=SendMessage,SMSGH.Message=Message,module.exports=SMSGH;
},{"./lib/auth":1,"./lib/error":2,"./lib/message":5,"./lib/sendmsg":6,"./lib/topup":7,"./lib/usp":8}]},{},[21]);
