...
function SMSGH(e,s,i){if(!(this instanceof SMSGH))return new SMSGH(e,s,i);if(!e||!s)throw new SMSGHError("Make sure clientid and clientSecret are both defined");this.clientId=e,this.clientSecret=s,this.apiKey=i,this.versionNumber="v3",this.messageApi=new SendMessage(e,s,this.versionNumber),this.apiKey&&(this.topUpApi=new TopUp(i))}var SMSGHError=require("./lib/error"),TopUp=require("./lib/topup"),SendMessage=require("./lib/sendmsg"),Message=require("./lib/message");SMSGH.prototype.setContextPath=function(e){"number"==typeof e&&(e="v"+e),this.versionNumber=e,this.messageApi.setContextPath(this.versionNumber)},SMSGH.TopUp=TopUp,SMSGH.SendMessage=SendMessage,SMSGH.Message=Message,module.exports=SMSGH;
