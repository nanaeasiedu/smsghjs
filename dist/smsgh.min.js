...
function SMSGH(e,s,t){if(!(this instanceof SMSGH))return new SMSGH(e,s,t);if(!e||!s||arguments.length<2)throw new SMSGHError("Make sure clientid and clientSecret are both defined");this.auth=new Auth(e,s),this.apiKey=t,this.versionNumber="v3",this.messageApi=new SendMessage(this.auth,this.versionNumber),this.apiKey&&(this.topUpApi=new TopUp(t))}var SMSGHError=require("./lib/error"),TopUp=require("./lib/topup"),SendMessage=require("./lib/sendmsg"),Message=require("./lib/message"),Auth=require("./lib/auth");SMSGH.prototype.setContextPath=function(e){"number"==typeof e&&(e="v"+e),this.versionNumber=e,this.messageApi.setContextPath(this.versionNumber)},SMSGH.TopUp=TopUp,SMSGH.SendMessage=SendMessage,SMSGH.Message=Message,module.exports=SMSGH;
},{"./lib/auth":2,"./lib/error":3,"./lib/message":5,"./lib/sendmsg":6,"./lib/topup":7}],2:[function(require,module,exports){
...
},{"./error":3,"./utils":8}],3:[function(require,module,exports){
...
},{"./error":3,"superagent":17}],5:[function(require,module,exports){
...
},{"./error":3,"./httpclient":4,"./utils":8}],8:[function(require,module,exports){
(function (Buffer){
...
},{"./error":3,"buffer":9}],9:[function(require,module,exports){
