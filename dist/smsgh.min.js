...
function Auth(t,e){if(!arguments.length||arguments.length<2)throw new SMSGHError("Auth requires both `clientId` and `clientSecret`");return this instanceof Auth?(this.clientId=t,this.clientSecret=e,void(this.basicAuth=utils.encode(this.clientId+":"+this.clientSecret))):new Auth(t,e)}var utils=require("./utils"),SMSGHError=require("./error");module.exports=Auth;

},{"./error":2,"./utils":8}],2:[function(require,module,exports){
function SMSGHError(r){Error.call(this),this.message="SMSGHJS: "+r,this.stack=(new Error).stack}var util=require("util");util.inherits(SMSGHError,Error),SMSGHError.prototype.name="SMSGHError",SMSGHError.prototype.toString=function(){return this.message},module.exports=SMSGHError;

},{"util":16}],3:[function(require,module,exports){
var request=require("superagent"),SMSGHError=require("./error"),httpClient={},reqArr=["get","post","put","del","head"];reqArr.forEach(function(e){httpClient[e]=function(r,t){if(!r.url)throw new SMSGHError("No URL was specified for the request. Provide `url` in the options object");r.headers||(r.headers={});var n=request[e](r.url),o=t&&"function"==typeof t?t:function(){};n.set(r.headers),r.data&&n.send(r.data),n.end(function(e,r){return e?o(e,r):void o(null,r)})}}),module.exports=httpClient;

},{"./error":2,"superagent":17}],4:[function(require,module,exports){
function isAnImportantParamMissing(e){for(var t=0,s=Message._importantParams.length;s>t;t++){var r=e[Message._importantParams[t]];if(null===r||void 0===r)return!0}}function Message(e){if(!(this instanceof Message))return new Message(e);if(this.type=e.type||0,this.clientReference=e.clientReference||null,this.direction=e.direction||"out",this.flashMessage=e.flash||null,this.messageId=e.messageId||null,this.networkId=e.networkId||null,this.rate=e.rate||null,this.registeredDelivery=e.registeredDelivery||null,this.status=e.status||null,this.time=e.time||null,this.udh=e.udh||null,this.units=e.units||null,this.updateTime=e.updateTime||null,isAnImportantParamMissing(e))throw new SMSGHError("Important message option missing. Required options are: `from`, `to` and  `content`");var t=0,s=Message._importantParams.length;for(t=0;s>t;t++)this[Message._importantParams[t]]=e[Message._importantParams[t]]}var SMSGHError=require("./error");Message.prototype.toJSON=function(){var e={},t=this;for(var s in t)if(t.hasOwnProperty(s)&&t[s]&&"function"!=typeof t[s]){var r=t[s];"to"===s&&(r=~r.indexOf("+")?r:"+"+r),e[s.charAt(0).toUpperCase()+s.substr(1)]=r}return e},Message.castToMessageObj=function(e){return new Message(e)},Message._importantParams=["content","from","to"],module.exports=Message;

},{"./error":2}],5:[function(require,module,exports){
function SendMessage(e,s){return this instanceof SendMessage?(this._noopCallback=function(){},this._headers={Accept:"application/json",Authorization:"Basic "+e.basicAuth},this.versionNumber=s||"v3",this.lastQueryTime=0,void this.setContextPath()):new SendMessage(e,s)}var util=require("util"),httpClient=require("./httpclient"),Message=require("./message"),utils=require("./utils"),SMSGHError=require("./error");SendMessage.prototype._callbackProvider=function(e){return e&&"function"==typeof e?e:this._noopCallback},SendMessage.prototype.setContextPath=function(e){e=e||this.versionNumber,SendMessage.BASE_URL=util.format(SendMessage.BASE_URL_PLC,e)},SendMessage.prototype.send=function(e,s){e instanceof Message||(e=Message.castToMessageObj(e)),s=this._callbackProvider(s),httpClient.post({url:SendMessage.BASE_URL,headers:utils.merge(this._headers,{"Content-Type":"application/json"}),data:e.toJSON()},function(e,t){return e?s(e,t):201===t.status||2===(t.status/100|0)?s(null,t.body):void s(null,t.body)})},SendMessage.prototype.sendQuickMessage=function(e,s,t,n){var i=new Message({from:e,to:s,content:t});this.send(i,n)},SendMessage.prototype.sendScheduledMessage=function(e,s){if(e instanceof Message||(e=Message.castToMessageObj(e)),!e.time)throw new SMSGHError("A scheduled message object must have a time value");this.send(e,s)},SendMessage.prototype.getMessage=function(e,s){s=this._callbackProvider(s),httpClient.get({headers:this._headers,url:SendMessage.BASE_URL+"/"+e},function(e,t){return e?s(e,t):void s(null,t.body)})},SendMessage.prototype.queryMessage=function(e,s){if(this.lastQueryTime&&~~((Date.now()-this.lastQueryTime)/1e3)<5)throw new SMSGHError("Query must be within 5 second intervals");this.lastQueryTime=Date.now(),s=this._callbackProvider(s),httpClient.get({url:SendMessage.BASE_URL+"?"+utils.serialize(e),headers:this._headers},function(e,t){return e?s(e,t):void s(null,t.body)})},SendMessage.prototype.rescheduleMessage=function(e,s,t){if(!e)throw new SMSGHError("Provide the message id of the message to be rescheduled");t=this._callbackProvider(t),httpClient.put({url:SendMessage.BASE_URL+"/"+e,headers:utils.merge(this._headers,{"Content-Type":"application/json"}),data:{Time:s}},function(e,s){return e?t(e,s):void t(null,s.body)})},SendMessage.prototype.cancel=function(e,s){s=this._callbackProvider(s),httpClient.del({url:SendMessage.BASE_URL+"/"+e,headers:this._headers},function(e,t){return e?s(e,t):void s(null,t.body)})},SendMessage.BASE_URL_PLC="https://api.smsgh.com/%s/messages",SendMessage.BASE_URL="",module.exports=SendMessage;

},{"./error":2,"./httpclient":3,"./message":4,"./utils":8,"util":16}],6:[function(require,module,exports){
function TopUp(e){if(!(this instanceof TopUp))return new TopUp(e);if(!e||"string"!=typeof e)throw new SMSGHError("TopUp expects an api key as a string");this.apiKey=e}var httpClient=require("./httpclient"),utils=require("./utils"),SMSGHError=require("./error");TopUp.prototype.topItUp=function(e,t){e&&"object"==typeof e||t(new SMSGHError("`topItUp` expects an options param and must be an object"),null),e.network=e.network.toLowerCase(),e.method=(void 0!==e.method?e.method:"GET").toLowerCase(),t=t||function(){};for(var o=!1,p=0,r=TopUp.NETWORKS.length;r>p;p++)if(TopUp.NETWORKS[p]===e.network){o=!0;break}o||t(new SMSGHError("Available network types are: `mtn`, `vodafone`, `expresso`, `airtel`, `tigo` or `glo`"),null);var n=utils.serialize({phone:e.phone,"line-type":e.lineType,network:e.network,amount:e.amount,"api-key":this.apiKey},!1,!0);"get"===e.method?httpClient.get({url:TopUp.BASE_URL+"?"+n},t):httpClient.post({url:TopUp.BASE_URL,headers:{"Content-Type":"application/x-www-form-urlencoded"},data:n},t)},TopUp.BASE_URL="https://api.smsgh.com/credit/topup",TopUp.NETWORKS=["mtn","vodafone","expresso","airtel","tigo","glo"],module.exports=TopUp;

},{"./error":2,"./httpclient":3,"./utils":8}],7:[function(require,module,exports){
function callbackWrapper(t){if(!t||"function"!=typeof t)throw new SMSGHError("Specify callback for request");return function(e,r){return e?t(e,r):t(null,r.body)}}function USP(t,e){if(!t)throw new SMSGHError("No `auth` object provided for instantiation.");return this instanceof USP?(this.token=e,void(this.defaultHeaders={Authorization:"Basic "+t.basicAuth,"Cotent-Type":"application/json",Accept:"application/json"})):new USP(t,e)}var SMSGHError=require("./error"),utils=require("./utils"),httpClient=require("./httpclient");USP.prototype.topupAirtime=function(t,e,r,a){t=USP.NETWORK_IDS[t.toLowerCase()];var o=this;if(!utils.isValidTelephoneNumber(r))throw new SMSGHError("Number `"+r+" is invalid ");a=callbackWrapper(a),httpClient.post({url:USP.BASE_URL+"usp/airtime",headers:o.defaultHeaders,data:{network:t.toString(),amount:e,phone:r,token:o.token}},a)},USP.prototype.payDSTV=function(t,e,r){if(arguments.length<2)throw new SMSGHError("`payDSTV` expects `account` and `amount` arguments");var a=this;r=callbackWrapper(r),httpClient.post({url:USP.BASE_URL+"usp/dstv",headers:a.defaultHeaders,data:{account:t,amount:e,token:a.token}},r)},USP.prototype.querySurflineDevice=function(t,e){if(!utils.isValidTelephoneNumber(t))throw new SMSGHError("Number `"+t+"` is invalid ");var r=this;e=callbackWrapper(e),httpClient.post({url:USP.BASE_URL+"usp/surfline?"+t,headers:r.defaultHeaders,data:{}},e)},USP.prototype.bundleSurflinePlus=function(t,e,r){if(e>50||!~[1,5,10,20,50].indexOf(e))throw new SMSGHError("Specified amount must be either 1,5,10,20 or 50");var a=this;r=callbackWrapper(r),httpClient.post({url:USP.BASE_URL+"usp/surflineplus",header:a.defaultHeaders,data:{device:t.toString(),amount:e,token:a.token}},r)},USP.prototype.bundleSurfline=function(t,e,r,a){if(e>50||!~[1,5,10,20,50].indexOf(e))throw new SMSGHError("Specified amount must be either 1,5,10,20 or 50");a=callbackWrapper(a);var o=this;httpClient.post({url:USP.BASE_URL+"usp/surflineplus",header:o.defaultHeaders,data:{device:t.toString(),amount:e,bundle:r,token:o.token}},a)},USP.prototype.payvodafoneInternet=function(t,e,r){r=callbackWrapper(r);var a=this;httpClient.post({url:USP.BASE_URL+"usp/vodafone-internet",header:a.defaultHeaders,data:{account:t,amount:e,token:a.token}},r)},USP.prototype.payVodafoneBills=function(t,e,r,a){if("postpaid"!==r||"broadband"!==r)throw new SMSGHError("`service` argument can be either `postpaid` or `broadband`");a=callbackWrapper(a);var o=this;httpClient.post({url:USP.BASE_URL+"usp/vodafone",header:o.defaultHeaders,data:{account:t,amount:e,service:r}},a)},USP.prototype.getAccountBalance=function(t){t=callbackWrapper(t);var e=this;httpClient.get({url:USP+"usp/account/"+e.token,header:e.defaultHeaders},t)},USP.NETWORK_IDS={airtel:62006,vodafone:62002,expresso:62004,mtn:62001,globacom:62007,tigo:62003},USP.BASE_URL="https://api.smsgh.com/",module.exports=USP;

},{"./error":2,"./httpclient":3,"./utils":8}],8:[function(require,module,exports){
(function (Buffer){
var SMSGHError=require("./error"),has={}.hasOwnProperty,utils={},tenNumberRegExp=/^0\d{9}$/,twelveNumberRegExp=/^\+?233\d{9}$/;utils.encode=function(e){return new Buffer(e).toString("base64")},utils.serialize=function(e,r,t){var n=[];for(var u in e)has.call(e,u)&&n.push((r?encodeURIComponent(u):u)+"="+(t?encodeURIComponent(e[u]):e[u]));return n.join("&")},utils.merge=function(){for(var e={},r=[].slice.call(arguments,0),t=0,n=r.length;n>t;t++)for(var u in r[t])has.call(r[t],u)&&r[t][u]&&(e[u]=r[t][u]);return e},utils.isValidTelephoneNumber=function(e){if(!/\d+/.test(e))throw new SMSGHError("Make sure "+e+" provided is a real number");return tenNumberRegExp.test(e)||twelveNumberRegExp.test(e)?!0:!1},module.exports=utils;

}).call(this,require("buffer").Buffer)
},{"./error":2,"buffer":9}],9:[function(require,module,exports){
...
function SMSGH(e){if(!(this instanceof SMSGH))return new SMSGH(e);if(!e.clientId||!e.clientSecret)throw new SMSGHError("`clientId` or `clientSecret` is undefined in the options provided");this.auth=new Auth(e.clientId,e.clientSecret),this.versionNumber="v3",this.messaging=new SendMessage(this.auth,this.versionNumber),e.topupApiKey&&(this.topUp=new TopUp(e.topupApiKey)),e.uspToken&&(this.usp=new USP(this.auth,e.uspToken))}var SMSGHError=require("./lib/error"),TopUp=require("./lib/topup"),SendMessage=require("./lib/sendmsg"),USP=require("./lib/usp"),Message=require("./lib/message"),Auth=require("./lib/auth");SMSGH.prototype.setContextPath=function(e){"number"==typeof e&&(e="v"+e),this.versionNumber=e,this.messaging.setContextPath(this.versionNumber)},SMSGH.TopUp=TopUp,SMSGH.SendMessage=SendMessage,SMSGH.Message=Message,module.exports=SMSGH;
},{"./lib/auth":1,"./lib/error":2,"./lib/message":4,"./lib/sendmsg":5,"./lib/topup":6,"./lib/usp":7}]},{},[20]);
