...
function SendMessage (clientId, clientSecret, apiVersion) {
  if (!(this instanceof SendMessage)) return new SendMessage(clientId, clientSecret, apiVersion)
  this.clientId = clientId
  this.clientSecret = clientSecret
  this._auth = utils.encode(this.clientId + ':' + this.clientSecret)
  this._noopCallback = function () {}
  this._headers = {
    'Accept': 'application/json',
    'Authorization': 'Basic ' + this._auth
  }
  this.versionNumber = apiVersion
  this.lastQueryTime
  this.setContextPath()
}
...
SendMessage.prototype.setContextPath = function () {
  SendMessage.BASE_URL = util.format(SendMessage.BASE_URL, this.versionNumber)
}
...
SendMessage.BASE_URL = 'https://api.smsgh.com/%s/messages'
